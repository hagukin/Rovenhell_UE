...
public:
	...
	void ApplyPlayerPhysics_UEClient(SD_GameState* gameState, const SD_PawnPhysics& playerPhysics, ANetHandler* netHandler); // 호스트 폰의 경우 클라와 서버의 싱크를 확인하고 필요서 PhysicsSyncComp로 보정한다; 퍼펫의 경우 InterpComp로 두 시점 사이의 움직임을 부드럽게 선형 보간 처리한다.
