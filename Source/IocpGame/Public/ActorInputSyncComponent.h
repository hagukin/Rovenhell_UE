...
public:
	void AddInputsInfo(ActionTypeEnum actionType, const FInputActionValue& Value, float deltaTime, uint32 tick, FVector PlayerFacingDirection); // Tail에 덮어쓰고 커서를 한 칸씩 이동시킨다
